...
cmake ${CMAKE_ARGS} \
  ...
  -DLLDB_PYTHON_RELATIVE_PATH:PATH="lib/python/site-packages" \
  ...
  -DPython3_LIBRARY:FILEPATH=$PREFIX/lib/libpython$PY_VER_NODOT$SHLIB_EXT \
  -DPython3_INCLUDE_DIRS:FILEPATH=$PREFIX/include/python$PY_VER \
